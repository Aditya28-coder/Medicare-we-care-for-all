...
<header>
	<div class="main">
		<ul>
            ...
            <li><a style="font-size: 25px" href="ngodetails.php">NGO Details</a></li>
            <li class="active"><a style="font-size: 25px" href="viewrequestadmin.php">Requested medicines</a></li>
